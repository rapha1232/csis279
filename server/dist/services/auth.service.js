...
let AuthService = class AuthService {
    ...
    async login(Email, Password) {
        ...
        if (!findUser) throw new _HttpException.HttpException(409, `This email ${Email} was not found`);
        const isPasswordMatching = await (0, _bcrypt.compare)(Password, findUser.Password);
